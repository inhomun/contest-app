                    ...
                    if showModal {
                        ...
                        GeometryReader { geometry in // the modal container
                            RoundedRectangle(cornerRadius: 16)
                                ...
                                .overlay(dataSaveDB(showModal: self.$showModal))
...
struct CurriculumDBView_Previews: PreviewProvider {
