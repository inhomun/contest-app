                    ...
                    if showModal {
                        ...
                        GeometryReader { geometry in // the modal container
                            RoundedRectangle(cornerRadius: 16)
                                ...
                                .overlay(dataSaveCN(showModal: self.$showModal))
...
struct CurriculumDCView_Previews: PreviewProvider {
